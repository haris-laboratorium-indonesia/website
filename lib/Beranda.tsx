...
export const CaraSayaMenyampaikanInformasi = [
  {
    ...
    description:
      'Di HarisLab, semua bab pelajaran dibuat sebuah struktur informasi sedemikia rupa agar mudah diingat. Sehingga kita bisa  berekspektasi kepada setiap bab nya, bahwa ini yang akan kita pelajari. Coba dan rasakan kemudahannya',
  },
  {
    id: '2',
  ...
  {
    id: '4',
    svg: 'M7.86 2h8.28L22 7.86v8.28L16.14 22H7.86L2 16.14V7.86L7.86 2z M15 9l-6 6 M9 9l6 6',
    title: 'Tanpa Iklan',
    description:
...
export const isiFAQ = [
  ...
  {
    id: '2',
    button: 'Kenapa membangun HarisLab ?',
    panel:
