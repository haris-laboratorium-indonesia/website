...
const Footer = () => {
  const navigation = 'block text-gray-400  hover:text-white font-inter py-1';
  return (
    <footer className='bottom-0 w-full mt-20 text-center bg-gray-800'>
      <section className='grid max-w-4xl grid-cols-1 gap-5 px-5 py-10 mx-auto text-left sm:grid-cols-2 xl:px-0 '>
        ...
        {/* Company Identity */}
        <article className='w-full pt-5 space-y-2 text-xs text-gray-400 sm:pt-0 sm:text-base'>
