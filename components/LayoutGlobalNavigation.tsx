...
export default function LayoutGlobalNavigation({
  ...
  return (
    <div className='bg-white'>
      ...
      <div className='sticky inset-x-0 top-0 z-40 mb-5 w-full border-b  border-zinc-300 bg-white/70 py-1.5 backdrop-blur'>
        <section className='mx-auto flex max-w-5xl items-center justify-between px-3 lg:px-0'>
          <h2 id='work' className='z-40 flex h-auto items-center'>
            <div className='text-xl sm:text-2xl font-bold text-zinc-700 '>{domain}</div>
          </h2>
        </section>
      </div>

      <main className='mx-auto min-h-screen w-full max-w-5xl px-5 pb-5 sm:pb-0 xl:px-0'>
        {children}
      </main>
