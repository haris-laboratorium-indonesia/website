  ...
  return (
    <div className='sticky z-40 -mx-3 sm:-mx-5 top-2'>
      <Menu as='div' className='flex flex-col w-full my-3 sm:my-5 sm:mx-auto'>
        <div className='flex items-center justify-between w-full px-1 mx-auto bg-gray-800 rounded-md shadow-2xl sm:w-1/2'>
          <Link href={materi}>
        ...
        <Menu.Items className='flex w-full sm:justify-center'>
          <div className='w-full p-2 mt-2 bg-gray-800 rounded-md shadow-2xl sm:w-1/2 '>
