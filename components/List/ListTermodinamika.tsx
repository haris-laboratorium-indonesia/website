  ...
  return (
    <div className='sticky z-40 -mx-3 sm:-mx-5 top-2'>
      <Menu as='div' className='flex flex-col w-full my-5 sm:mx-auto'>
        <div className='flex items-center justify-between w-full p-1 mx-auto bg-gray-800 rounded-md shadow-xl sm:w-1/2'>
          <Link href={materi}>
          ...
          <Link href={`/fisika/${page}`}>
            <a className='text-gray-200 hover:text-white'>{title}</a>
          </Link>
        ...
        <Menu.Items className='flex w-full sm:justify-center'>
          <div className='w-full py-2.5 px-2 mt-2 bg-gray-800 rounded-md sm:w-1/2  shadow-2xl '>
            <Menu.Item>
            ...
            <Menu.Item>
              <a className={H1} href='#Pembahasan'>
                Pembahasan{' '}
              </a>
            </Menu.Item>
            <Menu.Item>
