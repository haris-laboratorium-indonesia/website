...
const TabMath = ({ page, to }) => {
  return (
    <header className="z-40 flex flex-row items-center justify-between w-full h-auto my-5 py-2.5 border-b border-gray-500 bg-white  ">
      <div className="block text-xl sm:text-3xl font-semibold text-gray-800">{page}</div>
      <section className="flex flex-row items-center justify-end p-1 space-x-1 text-sm  bg-gray-50 border border-gray-300 rounded-lg">
