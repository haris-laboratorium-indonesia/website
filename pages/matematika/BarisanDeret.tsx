...
export default function BarisanDeret() {
  return (
    <LayoutMateri browserTitle='Barisan Deret' description='Materi Barisan Deret'>
      <List close='text-green-500' branch='matematika' to='BarisanDeret' title='Barisan Deret'>
      ...
      <A2 title='Apa itu Barisan Deret' />
      <A2 title='Siapa yang menggunakan Barisan Deret' />
      <A2 title='Dimana Barisan Deret digunakan' />
      <A2 title='Kapan Barisan Deret digunakan' />
      ...
      <TeX>{String.raw`\\Polylongdiv{x^3-7x^2+4x+50}{x-3}`}</TeX>
      ...
      <P>
        ...
        quae error lautium incidunt odit inventore unde enim molestias voluptates aut est, facere
        earum adipisci?
      </P>
