...
export default function Statistika() {
  return (
    <LayoutMateri browserTitle='Statistika' description='Materi Statistika'>
      <List close='text-green-500' branch='matematika' to='Statistika' title='Statistika'>
      ...
      <A2 title='Apa itu Statistika' />
      <A2 title='Siapa yang menggunakan Statistika' />
      <A2 title='Dimana Statistika digunakan' />
      <A2 title='Kapan Statistika digunakan' />
