...
export default function Matematika() {
  const sectionStyle =
    'grid grid-cols-1 overflow-hidden  divide-y divide-gray-300 rounded-md xs:gap-3 xs:divide-y-0 xs:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xs:-mx-1 xs:px-1 xs:py-1 xs:border-0 shadow-md xs:shadow-none';
  return (
    <Layout
