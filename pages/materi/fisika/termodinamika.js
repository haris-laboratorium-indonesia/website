...
const termodinamika = () => {
  ...
  return (
    <Layout title="Termodinamika" description="Materi Termodinamika">
      ...
      <div className="mt-10 mb-5 text-5xl font-semibold font-mw">Termodinamika</div>
      <Image
        src={Termodinamika}
        alt="Termodinamika"
        placeholder="blur"
      ...
      pariatur exercitationem provident deserunt neque excepturi nisi voluptates
      saepe quidem commodi esse, atque odio incidunt voluptatum porro ipsum
      reiciendis iusto nostrum laboriosam.
      {/* variabel */}
